                ...
                <div class="row">
                  <div class="col-md-8 text-center text-md-left">
                    ...
                    <p class="lead">
                      ...
                      <br />
                      <em>Zocurelia</em> wants to help you organize reading together, especially when your community is spread all over the world, your school, your university or your city.
                    </p>
                  </div>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-12">
                  <p class="lead text-break">
                    <img
                      class="float-left img-fluid motivation-logo"
                ...
                <div class="col-lg-6 col-md-12">
                  <p class="lead text-break">
                    <svg
                      ...
                      width="24"
                    >
                      <path d="M3.886 3.945H21.03v16.047H3.886z" fill="#fff" />
                      <path
