              ...
              <div class="container" style="word-break: break-word">
                <div class="row">
                  <div>
                    ...
                    <p>Zocurelia bezieht seine Informationen aus den Online-Schnittstellen (APIs) von Zotero und Hypothesis. Das Anlegen eines Nutzeraccounts in Zocurelia ist nicht notwendig, um die Anwendung grundsätzlich verwenden zu können. Um sinnvoll damit arbeiten zu können, ist ein Account bei Hypothesis notwendig. Er muss auf der Webpräsenz von Hypothesis angelegt werden.</p>
                    <p>Das Eintragen eines Hypothesis-Tokens ist nur erforderlich, wenn Zocurelia mit so genannten privaten Gruppen in Hypothesis interagieren soll. Dieses Token wird im lokalen Speicher des Browsers abgelegt (localStorage) und kann über die Seite Einstellungen wieder entfernt werden.</p>
                    <p>Bitte beachten Sie, dass beim Ansprechen der APIs von Zotero und Hypothesis Ihre IP-Adresse übertragen wird.</p>
                    <h2>In simple words</h2>
                    <p>The following privacy policy complies with the legal requirements for this site. Nevertheless, at the beginning we will try to describe the technical connections briefly and comprehensibly.</p>
                    <p>Zocurelia gets its information from the online interfaces (APIs) of Zotero and Hypothesis. It is not necessary to create a user account in Zocurelia to use the application. In order to be able to work with it, an account with Hypothesis is necessary. It must be created on the Hypothesis website.</p>
                    <p>The entry of a hypothesis token is only necessary if Zocurelia is to interact with so-called private groups in hypothesis. This token is stored in the local memory of the browser (localStorage) and can be removed via the page Settings.</p>
                    <p>Please note that when addressing the Zotero and Hypothesis APIs, your IP address will be transmitted.</p>
                    ...
                    <ul class="index">
                      ...
                      <li>
                        <a class="index-link" href="#m182">Kontaktaufnahme</a>
                      </li>
                      <li>
                        <a
                          class="index-link"
                    ...
                    <p>
                      <strong>E-Mail-Adresse</strong>: kontakt@axel-duerkop.de
                    </p>
                    <ul class="m-elements"></ul>
                    ...
                    <p>
                      <strong>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out):</strong> Unabhängig davon, ob die Verarbeitung auf Grundlage einer Einwilligung oder gesetzlichen Erlaubnis erfolgt, haben Sie jederzeit die Möglichkeit, eine erteilte Einwilligung zu widerrufen oder der Verarbeitung Ihrer Daten durch Cookie-Technologien zu widersprechen (zusammenfassend als "Opt-Out" bezeichnet).
                    </p>
                    ...
                    <p>
                      Ein Widerspruch gegen den Einsatz von Cookies zu Zwecken des Onlinemarketings kann auch mittels einer Vielzahl von Diensten, vor allem im Fall des Trackings, über die US-amerikanische Seite
                      <a
                      ...
                      <a
                        ...
                        target="_blank"
                      >http://www.youronlinechoices.com/</a> oder generell auf
                      <a
                        href="http://optout.aboutads.info"
                        target="_blank"
                      >http://optout.aboutads.info</a> erklärt werden.
                    </p>
                    <p>
                    ...
                    <ul class="m-elements">
                      <li>
                        <p>
                          <strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z.B. Namen, Adressen), Kontaktdaten (z.B. E-Mail, Telefonnummern), Inhaltsdaten (z.B. Texteingaben, Fotografien, Videos).
                        </p>
                      </li>
                      <li>
                        <p>
                    ...
                    <ul class="m-elements">
                      <li>
                        <p>
                          <strong>Verarbeitete Datenarten:</strong> Inhaltsdaten (z.B. Texteingaben, Fotografien, Videos), Nutzungsdaten (z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten), Meta-/Kommunikationsdaten (z.B. Geräte-Informationen, IP-Adressen).
                        </p>
                      </li>
                      <li>
                        <p>
                    ...
                    <ul class="m-elements">
                      <li>
                        <p>
                          <strong>Cloudflare:</strong> Content-Delivery-Network (CDN); Dienstanbieter: Cloudflare, Inc., 101 Townsend St, San Francisco, CA 94107, USA; Website:
                          <a
                            href="https://www.cloudflare.com"
                            target="_blank"
                          >https://www.cloudflare.com</a>; Datenschutzerklärung:
                          <a
                            href="https://www.cloudflare.com/privacypolicy/"
                            target="_blank"
                          >https://www.cloudflare.com/privacypolicy/</a>; Privacy Shield (Gewährleistung Datenschutzniveau bei Verarbeitung von Daten in den USA):
                          <a
                    ...
                    <ul class="m-elements">
                      <li>
                        <p>
                          <strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten), Meta-/Kommunikationsdaten (z.B. Geräte-Informationen, IP-Adressen), Bestandsdaten (z.B. Namen, Adressen), Kontaktdaten (z.B. E-Mail, Telefonnummern), Inhaltsdaten (z.B. Texteingaben, Fotografien, Videos).
                        </p>
                      </li>
                      <li>
                        <p>
                      ...
                      <li>
                        <p>
                          <strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit, Vertragliche Leistungen und Service, Sicherheitsmaßnahmen, Verwaltung und Beantwortung von Anfragen.
                        </p>
                      </li>
                      <li>
                        <p>
                    ...
                    <ul class="m-elements">
                      <li>
                        <p>
                          <strong>YouTube:</strong> Videos; Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website:
                          <a
                            href="https://www.youtube.com"
                            target="_blank"
                          >https://www.youtube.com</a>; Datenschutzerklärung:
                          <a
                            href="https://policies.google.com/privacy"
                            target="_blank"
                          >https://policies.google.com/privacy</a>; Privacy Shield (Gewährleistung Datenschutzniveau bei Verarbeitung von Daten in den USA):
                          <a
                            href="https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active"
                            target="_blank"
                          >https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active</a>; Widerspruchsmöglichkeit (Opt-Out): Opt-Out-Plugin:
                          <a
                            href="http://tools.google.com/dlpage/gaoptout?hl=de"
                            target="_blank"
                          >http://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von Werbeeinblendungen:
                          <a
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>Beschwerde bei Aufsichtsbehörde:</strong> Sie haben ferner nach Maßgabe der gesetzlichen Vorgaben das Recht, bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat Ihres gewöhnlichen Aufenthaltsorts, Ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes, wenn Sie der Ansicht sind, dass die Verarbeitung der Sie betreffenden personenbezogenen Daten gegen die DSGVO verstößt.
                      </li>
                    </ul>
